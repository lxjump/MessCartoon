...
public final class HandlerDispatcherKt {
    ...
    static {
        Object m9680constructorimpl;
        try {
            Result.Companion companion = Result.Companion;
            m9680constructorimpl = Result.m9680constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m9680constructorimpl = Result.m9680constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m9686isFailureimpl(m9680constructorimpl) ? null : m9680constructorimpl;
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo11230dispatch(cont.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
